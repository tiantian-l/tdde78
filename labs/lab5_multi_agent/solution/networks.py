"""
Neural Network Architectures for Multi-Agent RL — SOLUTION.
...
# =============================================================================
#  Centralized Critic — New component for Lab 5  (MAPPO)
# =============================================================================
...
class CentralizedCritic(nn.Module):
    ...
    *** This is the main new component students implement in Lab 5. ***
    ...
    def __init__(self, obs_dim: int, n_agents: int):
        ...
        self.net = nn.Sequential(
            layer_init(nn.Linear(joint_dim, 128)),
            nn.Tanh(),
...
# =============================================================================
#  MADDPG Networks  (Multi-Agent DDPG)
# =============================================================================
